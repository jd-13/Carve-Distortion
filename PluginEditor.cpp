    ...
    : AudioProcessorEditor(ownerFilter)
{
    ...
    PreGain2Sld->setTextBoxStyle (Slider::TextBoxLeft, false, 80, 20);
    ...
    PostGain2Sld->setTextBoxStyle (Slider::TextBoxLeft, false, 80, 20);
    ...
    Tweak2Sld->setTextBoxStyle (Slider::TextBoxLeft, false, 80, 20);
    ...
    RoutingSld->setTextBoxStyle (Slider::TextBoxLeft, false, 80, 20);
...
void CarveAudioProcessorEditor::resized()
{
    ...
    PreGain1Sld->setBounds (24, 72, 150, 24);
    PostGain1Sld->setBounds (24, 104, 150, 24);
    Tweak1Sld->setBounds (24, 136, 150, 24);
    Mode1Cmb->setBounds (24, 40, 150, 24);
    DbgLbl->setBounds (104, 320, 150, 24);
    PreGain2Sld->setBounds (200, 72, 150, 24);
    PostGain2Sld->setBounds (200, 104, 150, 24);
    Tweak2Sld->setBounds (200, 136, 150, 24);
    Mode2Cmb->setBounds (200, 40, 150, 24);
    RoutingSld->setBounds (80, 224, 150, 24);
...
<JUCER_COMPONENT documentType="Component" className="CarveAudioProcessorEditor"
  ...
  <SLIDER name="PreGain 1 Slider" id="f32c9f6afaac55bd" memberName="PreGain1Sld"
          virtualName="" explicitFocusOrder="0" pos="24 72 150 24" min="0"
  ...
  <SLIDER name="PostGain 1 Slider" id="6c5a77936be07efe" memberName="PostGain1Sld"
          virtualName="" explicitFocusOrder="0" pos="24 104 150 24" min="0"
          max="2" int="0.010000000000000000208" style="RotaryVerticalDrag"
          textBoxPos="TextBoxLeft" textBoxEditable="1" textBoxWidth="80"
          textBoxHeight="20" skewFactor="1"/>
  <SLIDER name="Tweak 1 Slider" id="94990f0dcf6af35d" memberName="Tweak1Sld"
          virtualName="" explicitFocusOrder="0" pos="24 136 150 24" min="-1"
  ...
  <SLIDER name="Routing Slider" id="f14b87e6d580ecee" memberName="RoutingSld"
          virtualName="" explicitFocusOrder="0" pos="80 224 150 24" min="0"
